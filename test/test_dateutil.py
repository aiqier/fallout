...
class TestDateUtil(object):
    ...
    def test_datetime_to_timestamp_ms(self):
        ...
        print dateutil.strf_y_m_d_add_day("2019-10-15", 2)
        print dateutil.strf_y_m_d_deduct_day("2019-10-15", 2)
...
def main():
    testDateUtil = TestDateUtil()
    testDateUtil.test_datetime_to_timestamp_ms()
